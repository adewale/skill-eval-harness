...
# Conservative at module granularity: every module split out of the former
# skill_benchmark.py monolith is identified, so any edit to that code still
# invalidates trigger identity, exactly as an edit to the monolith did.
