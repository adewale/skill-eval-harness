...
# Every top-level module (the CLI, the harness modules it re-exports, the
# runners, and the contracts) plus the shipped Pi smoke example, so a new
# module is citable without editing this map. A name defined in two modules
# must be cited qualified.
MODULES = {
