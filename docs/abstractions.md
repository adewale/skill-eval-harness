...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10755`), Claude (`run_claude:10966`, capturing real
...
subagent runner (`run_subagent:13569`, which hosts record/replay tool I/O via `ToolReplayStore`),
