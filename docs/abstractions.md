...
(`run_pi_trigger_eval.py`), Codex (`run_codex:3960`), Claude (`run_claude:4069`, capturing real
per-run cost), the in-process subagent runner (`run_subagent:5165`, which hosts record/replay
