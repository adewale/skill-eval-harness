...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10854`), Claude (`run_claude:11040`, capturing real
...
subagent runner (`run_subagent:13691`, which hosts record/replay tool I/O via `ToolReplayStore`),
