...
(`run_pi_trigger_eval.py`), Codex (`run_codex:3480`), Claude (`run_claude:3625`, capturing real
per-run cost), the in-process subagent runner (`run_subagent:4376`, which hosts record/replay
