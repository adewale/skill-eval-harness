...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:11078`), Claude (`run_claude:11264`, capturing real
...
subagent runner (`run_subagent:13972`, which hosts record/replay tool I/O via `ToolReplayStore`),
