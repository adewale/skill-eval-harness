...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:11026`), Claude (`run_claude:11212`, capturing real
...
subagent runner (`run_subagent:13920`, which hosts record/replay tool I/O via `ToolReplayStore`),
