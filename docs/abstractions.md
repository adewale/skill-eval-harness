...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10743`), Claude (`run_claude:10930`, capturing real
...
subagent runner (`run_subagent:13533`, which hosts record/replay tool I/O via `ToolReplayStore`),
