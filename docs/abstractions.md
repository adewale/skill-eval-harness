...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10997`), Claude (`run_claude:11183`, capturing real
...
subagent runner (`run_subagent:13853`, which hosts record/replay tool I/O via `ToolReplayStore`),
